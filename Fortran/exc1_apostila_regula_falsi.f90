PROGRAM exc1_apostila_regula_falsi
! Purpose:  Thermodynamics exercise 1 from the apostila! A program about regula falsi method!
!          
...
END PROGRAM exc1_apostila_regula_falsi